      ...
      <el-col :span="8">
        <el-card class="dash_top_card">
          ...
          <ul @click="goNum">
            <li>
              租赁：
              <span>{{ rentTotalOrderNum }}</span>
            </li>
            <li>
              出售：
              <span>{{ saleTotalOrderNum }}</span>
            </li>
            <li>
              定制：
              <span>{{ customizeTotalOrderNum }}</span>
            </li>
          </ul>
        </el-card>
      </el-col>
...
export default {
  data() {
    return {
      ...
      radioq: 1,
      oneDateRange: [
        dateFormat(subDays(new Date(), 0), 'yyyy-MM-dd'),
  ...
  computed: {
    ...
    totalOrderNum() {
      return (
        this.rentTotalOrderNum +
        this.saleTotalOrderNum +
        this.customizeTotalOrderNum
      )
    },
    abnormalTotalNum() {
      return (
